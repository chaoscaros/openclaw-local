...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "taskmode.list", scope: "operator.read" },
  { name: "taskmode.get", scope: "operator.read" },
  { name: "taskmode.create", scope: "operator.write" },
  { name: "taskmode.update", scope: "operator.write" },
  { name: "taskmode.sync", scope: "operator.write" },
  { name: "taskmode.archive", scope: "operator.write" },
  { name: "taskmode.restore", scope: "operator.write" },
  { name: "taskmode.delete", scope: "operator.write" },
  { name: "taskmode.todo.create", scope: "operator.write" },
  { name: "taskmode.todo.update", scope: "operator.write" },
  { name: "taskmode.todo.setStatus", scope: "operator.write" },
  { name: "taskmode.todo.delete", scope: "operator.write" },
