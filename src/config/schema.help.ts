...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.list[].heartbeat.timeoutSeconds":
    "Per-agent maximum time in seconds allowed for a heartbeat agent turn before it is aborted. Leave unset to inherit the merged heartbeat/default agent timeout or the heartbeat cadence capped at 600 seconds.",
