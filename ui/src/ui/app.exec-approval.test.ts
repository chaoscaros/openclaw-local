...
async function createApp(
  ...
  const app = {
    ...
    handleExecApprovalDecision: OpenClawApp.prototype.handleExecApprovalDecision,
  } as unknown as InstanceType<typeof OpenClawApp>;
  return app;
}
...
describe("OpenClawApp exec approval decisions", () => {
  ...
  it("dismisses the active approval after a successful decision", async () => {
