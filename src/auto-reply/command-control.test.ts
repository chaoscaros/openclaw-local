...
describe("resolveCommandAuthorization", () => {
  ...
  it("requires a real owner identity for owner-enforced commands even with wildcard allowFrom", () => {
    const cfg = {
      commands: { ownerAllowFrom: ["whatsapp:+155****4567"] },
      channels: { whatsapp: { allowFrom: ["*"] } },
    } as OpenClawConfig;
