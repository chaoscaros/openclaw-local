...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "approvals.exec.enabled": "启用执行审批转发",
  ...
  "approvals.exec.targets[].channel": "审批目标渠道",
  "approvals.exec.targets[].to": "审批目标地址",
  "approvals.exec.targets[].accountId": "审批目标账号 ID",
  "approvals.exec.targets[].threadId": "审批目标线程 ID",
  "approvals.plugin": "插件审批转发",
  "approvals.plugin.enabled": "启用插件审批转发",
  "approvals.plugin.mode": "插件审批转发模式",
  "approvals.plugin.agentFilter": "插件审批代理过滤器",
  "approvals.plugin.sessionFilter": "插件审批会话过滤器",
  "approvals.plugin.targets": "插件审批转发目标",
  "approvals.plugin.targets[].channel": "插件审批目标渠道",
  "approvals.plugin.targets[].to": "插件审批目标地址",
  "approvals.plugin.targets[].accountId": "插件审批目标账号 ID",
  "approvals.plugin.targets[].threadId": "插件审批目标线程 ID",
  ...
  "models.providers.*.timeoutSeconds": "Model Provider Timeout (sec)",
