...
export const en: TranslationMap = {
  ...
  quickSettings: {
    ...
    identity: {
      ...
      storedInBrowser: "Stored in this browser only.",
      ...
      errors: {
        ...
        cannotRenderAvatar: "Cannot render avatar",
      },
    },
    profiles: {
      title: "Context Profile",
      eyebrow: "Bootstrap Context",
      intro:
      ...
      context: {
        ...
        everyTurnDescription: "Reinject workspace bootstrap context on every turn.",
        skipSafeFollowupsDescription:
          "Skip bootstrap reinjection after a completed safe follow-up.",
      },
      was: "Was {value}",
      matchesCurrentDefault: "Matches current default",
      selectedPending: "{profile} is selected but not saved yet.",
      selectedPendingCopy:
      ...
      scopeCopy: "Profiles only change bootstrap size and follow-up reinjection behavior.",
      customActive: "Custom bootstrap settings are active.",
      customActiveCopy: "Choose a built-in profile to replace the current custom values.",
  ...
  taskModeUi: {
    ...
    banner: {
      ...
      selectTask: "Select a task to continue",
      openTasks: "Open task board",
    },
    actions: {
      close: "Close",
      create: "Create",
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "回顾",
      title: "每日日志回顾",
      description: "查看哪些内容来自每日日志、哪些仍在等待提升、哪些最近已经完成提升。",
      summaryFromDailyLog: "来自每日日志",
      summaryWaiting: "等待提升",
      summaryPromotedToday: "今日已提升",
      stagedTitle: "来自每日日志",
      stagedDescription: "来自较早每日日志的回放候选。",
      shortTermTitle: "等待提升",
      shortTermDescription: "当前仍在等待进入真实记忆的短期候选。",
      sortRecent: "最近优先",
      sortSignals: "支持最强",
      originDailyLog: "回放",
      originLive: "实时",
      ...
      emptyGrounded: "当前没有已暂存的回放条目。",
      emptyShortTerm: "当前没有可查看的短期条目。",
      emptyPromoted: "当前没有可查看的最近提升。",
      updatedPrefix: "更新于",
    },
    stats: {
      shortTerm: "短期",
    ...
    trace: {
      ...
      promoted: "已提升",
      groundedLed: "回放主导",
      emptyShortTerm: "当前没有活跃的短期条目。",
      emptyGrounded: "当前没有已暂存的回放条目。",
      emptySignals: "当前没有活跃信号。",
      emptyPromoted: "今天还没有提升条目。",
    },
    diary: {
      title: "梦境日记",
      noDreamsYet: "还没有梦境记录",
      noDreamsHint: "第一次梦境周期跑完后，内容会出现在这里。",
      waitingTitle: "日记还在等待内容",
      waitingHint: "下一次梦境周期后会出现叙事条目。",
      older: "更早",
      newer: "更新",
      reload: "重新加载",
      reloading: "重新加载中…",
    ...
    phrases: {
      consolidatingMemories: "正在整理记忆…",
      tidyingKnowledgeGraph: "正在整理知识图谱…",
      replayingConversations: "正在回放今天的对话…",
      weavingShortTerm: "正在把短期内容织入长期记忆…",
      defragmentingMindPalace: "正在整理心智宫殿…",
      filingLooseThoughts: "正在归档零散念头…",
      connectingDots: "正在连接分散线索…",
      compostingContext: "正在分解旧上下文窗口…",
      alphabetizingSubconscious: "正在给潜意识排序…",
      promotingHunches: "正在提升有前景的直觉…",
      forgettingNoise: "正在忘掉无关噪音…",
      dreamingEmbeddings: "正在向量嵌入里做梦…",
      reorganizingAttic: "正在重整记忆阁楼…",
      indexingDay: "正在轻轻索引这一天…",
      nurturingInsights: "正在培育刚冒头的洞察…",
      simmeringIdeas: "正在慢炖半成形的想法…",
      whisperingVectorStore: "正在和向量库低声交谈…",
    },
  },
  usage: {
    page: {
