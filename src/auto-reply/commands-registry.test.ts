...
describe("commands registry", () => {
  ...
  it("matches text command aliases case-insensitively while preserving arguments", () => {
    ...
    const compact = resolveTextCommand("/COMPACT Keep CaseSensitivePath");
    expect(compact?.command.key).toBe("compact");
    expect(compact?.args).toBe("Keep CaseSensitivePath");
  });
