...
import { buildConfiguredModelCatalog } from "./model-selection.js";
...
function appendCatalogEntriesIfAbsent(models: ModelCatalogEntry[], entries: ModelCatalogEntry[]): void {
