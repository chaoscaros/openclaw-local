...
describe("loadOpenClawPlugins", () => {
  ...
  register(api) {
    ...
    withEnv({ ENV_CONFIG_PROBE_SECRET: "process-env-secret" }, () => {
      loadRegistryFromSinglePlugin({
        ...
        options: {
          ...
          env: {
            ...envWithoutBundled,
            ENV_CONFIG_PROBE_SECRET: process.env.ENV_CONFIG_PROBE_SECRET,
          },
    ...
    loadRegistryFromSinglePlugin({
      ...
      options: {
        activate: false,
        env: { ...envWithoutBundled, ENV_CONFIG_PROBE_SECRET: "explicit-env-secret" },
        resolveRawConfigEnvVars: true,
      },
    });
    ...
    withEnv({ ENV_CONFIG_PROBE_SECRET: undefined }, () => {
      loadOpenClawPlugins({
        ...
        activate: false,
        env: { ...envWithoutBundled, ENV_CONFIG_PROBE_SECRET: undefined },
        resolveRawConfigEnvVars: true,
      });
    });
