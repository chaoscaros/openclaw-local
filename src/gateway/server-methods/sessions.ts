...
function inheritSessionRuntimeSelection(
  ...
  return {
    ...
    ...(parentEntry.modelOverrideSource
      ...
      : {}),
    ...(parentEntry.modelOverrideFallbackOriginProvider
      ? { modelOverrideFallbackOriginProvider: parentEntry.modelOverrideFallbackOriginProvider }
      : {}),
    ...(parentEntry.modelOverrideFallbackOriginModel
      ? { modelOverrideFallbackOriginModel: parentEntry.modelOverrideFallbackOriginModel }
      : {}),
    ...
    ...(parentEntry.authProfileOverrideSource
      ...
      : {}),
    ...(typeof parentEntry.authProfileOverrideCompactionCount === "number"
      ? { authProfileOverrideCompactionCount: parentEntry.authProfileOverrideCompactionCount }
      : {}),
  };
}
